...
#End Region
    ...
    Public Shared Function GetPicAndUser(pUtilizador As String) As ClsEntidades
        Dim mClsEntidades As New ClsEntidades
    ...
    Public Shared Function GetEntidadesByFLG(Optional ByVal pFLG_Entidade As String = "C") As List(Of ClsEntidades)
        Dim mListaEntidades As New List(Of ClsEntidades)
    ...
    Public Shared Function GravaEntidades(ByVal pNovoEntidades As ClsEntidades) As Boolean
        ...
        Select Case pNovoEntidades.Cod_Entidade.Substring(0, 1)
            Case "V"
                menCont = enCont.Veterinarios
            Case "F"
                menCont = enCont.Funcionarios
            Case "C"
                menCont = enCont.Clientes
        End Select

...
Public Class ClsCategorias
    ...
    'Return "C" & ClsEmpresas.GetContador(enCont.Categorias).ToString("000")' <-------------- VERIFICAR O Nº de ZEROS
    ...
    Public Shared Function GravaCategorias(ByVal pNovoCategorias As ClsCategorias) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Categoria", pNovoCategorias.Cod_Categoria.Substring(0, IIf(Len(pNovoCategorias.Cod_Categoria) > 6, 6, Len(pNovoCategorias.Cod_Categoria))))

...
''' <summary>
'''      Classe ClsTipos_Animais Classe da Tabela Tipos_Animais
'''      Gerado em 03/03/2023 15:49:35
''' </summary>
''' <remarks>
'''      (c) ETLA - PM-2023
''' </remarks>
Public Class ClsTipos_Animais
    ...
    '''      (c) ETLA - PM-2023
    ''' </remarks>
    Public Shared Function GetTipos_Animais() As List(Of ClsTipos_Animais)
        Dim mListaTipos_Animais As New List(Of ClsTipos_Animais)
        ...
        While mRDR.Read()
            ...
            Dim mClsTipos_Animais As New ClsTipos_Animais
    ...
    '''      (c) ETLA - PM-2023
    ''' </remarks>
    Public Shared Function FiltrarTipos_Animais(ByVal pFiltro As ClsTipos_Animais) As List(Of ClsTipos_Animais)
        Dim mListaTipos_Animais As New List(Of ClsTipos_Animais)
        Dim mLista As New List(Of ClsTipos_Animais)
    ...
    '''      (c) ETLA - PM-2023
    ''' </remarks>
    Public Shared Function GetTipos_AnimaisByCod(ByVal pCod_Tipo_Animal As String) As ClsTipos_Animais
        Dim mClsTipos_Animais As New ClsTipos_Animais
    ...
    ''' <summary>
    '''      Function ModificaTipos_Animais(ByVal pClsTipos_Animais As ClsTipos_Animais) Método para Modificar a TABELA Tipos_Animais
    '''      Gerado em 03/03/2023 15:49:35
    ''' </summary>
    ''' <returns>
    '''      Boolean
    ...
    '''      (c) ETLA - PM-2023
    ''' </remarks>
    Public Shared Function ModificaTipos_Animais(ByVal pClsTipos_Animais As ClsTipos_Animais) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pAnimal", pClsTipos_Animais.Animal.Substring(0, IIf(Len(pClsTipos_Animais.Animal) > 15, 15, Len(pClsTipos_Animais.Animal))))
    ...
    ''' <summary>
    '''      Function GravaTipos_Animais(ByVal pNovoTipos_Animais As ClsTipos_Animais) Método para Gravar a TABELA Tipos_Animais
    '''      Gerado em 03/03/2023 15:49:35
    ''' </summary>
    ''' <returns>
    '''      Boolean
    ...
    '''      (c) ETLA - PM-2023
    ''' </remarks>
    Public Shared Function GravaTipos_Animais(ByVal pNovoTipos_Animais As ClsTipos_Animais) As Boolean
        Dim mReturn As Boolean = True
...
'''      (c) ETLA - PM-2023
''' </remarks>
Public Class Tipos_AnimaisComparer
    Implements IEqualityComparer(Of ClsTipos_Animais)

    Public Function Equals1(ByVal x As ClsTipos_Animais, ByVal y As ClsTipos_Animais) As Boolean Implements IEqualityComparer(Of ClsTipos_Animais).Equals
    ...
    Public Function GetHashCode1(ByVal pCls As ClsTipos_Animais) As Integer Implements IEqualityComparer(Of ClsTipos_Animais).GetHashCode

...
#Region "Properties"
    ...
    '    Get
    '        Return If(Cod_Consulta = "", 0, ClsIVA.GetIVAByTipo(ClsConsultas.GetConsultasByCod(Cod_Consulta).Cod_Tipo_Consulta))
    '    End Get
    'End Property
    ...
    '    Get
    '        Return If(Cod_Artigo = "", 0D, ((P_Unitario * Quantidade) - Valor_Desconto) * (Taxa_IVA / 100))
    '    End Get
    'End Property
    ...
    'Public ReadOnly Property Data_Doc As Date
    '    Get
    '        Return If(Num_Doc = "", "", ClsDoc.GetDocByCod(Num_Doc).Data_Doc)
    '    End Get
    'End Property
    ...
    Public Property P_Unitario As Decimal
        ...
        Get
            ...
            mPreco = If(Cod_Artigo = "", 0D, ClsArtigos.GetArtigosByCod(Cod_Artigo).Preco_Venda)
            'Else
            ' mPreco = If(Cod_Artigo = "", 0D, ClsArtigos.GetArtigosByCod(Cod_Artigo).Preco_Compra)
            'End If
...
#End Region
    ...
    Sub New(pNum_Doc As String, pLinha As Integer, pArtigo As ClsArtigos, pQTD As Integer, pDSC As Integer, pFLG_Entidade As String)
        ...
        Me.strValor_Iliquido = FormatCurrency(Valor_Iliquido, 2)
    ...
    Public Shared Function ModificaLinhas(ByVal pClsLinhas As ClsLinhas) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Consulta", pClsLinhas.Cod_Consulta.Substring(0, IIf(Len(pClsLinhas.Cod_Consulta) > 5, 5, Len(pClsLinhas.Cod_Consulta))))

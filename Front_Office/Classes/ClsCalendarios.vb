...
Public Class ClsCalendarios
    ...
    Public Property Cal_Detalhes As List(Of ClsCalendario_Detalhes)
    ...
    Sub New()
    End Sub
    Sub New(pAno As String)
        Cod_Calendario = "CAL" & pAno.Substring(2, 2)
        Designacao = "Calendário do Ano " & pAno
        Ano = pAno
        Cal_Detalhes = ClsCalendario_Detalhes.Cria_Detalhes_Feriados(pAno) 'ClsCalendario_Detalhes.GetCalendario_DetalhesByAno(pAno)
        FLG_Ativo = True
    End Sub
    ...
    '    Return "CAL" & ClsEmpresas.GetContador(enCont.Calendarios).ToString("00") ' <-------------- VERIFICAR O Nº de ZEROS
    ...
    Public Shared Function GetCalendariosByCod(ByVal pCod_Calendario As String) As ClsCalendarios
        ...
        If mRDR.Read() Then
            ...
            With mClsCalendarios
                ...
                .Cal_Detalhes = ClsCalendario_Detalhes.GetLista_Calendario_DetalhesByCod(.Cod_Calendario)

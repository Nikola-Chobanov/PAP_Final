...
Public Class UC_Calendarios
    ...
    Private Sub SCAgendas_EditAppointmentFormShowing_1(sender As Object, e As DevExpress.XtraScheduler.AppointmentFormEventArgs) Handles SCAgendas.EditAppointmentFormShowing
        Dim scheduler As DevExpress.XtraScheduler.SchedulerControl = CType(sender, DevExpress.XtraScheduler.SchedulerControl)
        Dim form As G02_Nikola_04.OutlookAppointmentForm = New G02_Nikola_04.OutlookAppointmentForm(scheduler, e.Appointment, e.OpenRecurrenceForm)
        Try

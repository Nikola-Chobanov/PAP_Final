...
Public Class ClsCP_Localidades
    ...
    Public Shared Function GetCP_Localidades() As List(Of ClsCP_Localidades)
        ...
        mStrSQL += "WHERE Cod_Postal LIKE  '7%' "
    ...
    Friend Shared Function GetCodPostalByLocalidade(ByVal Localidade As String) As List(Of ClsCP_Localidades)
        Dim mCodPostalByLocalidade As New List(Of ClsCP_Localidades)
        ...
        mDB.ConnectionString = My.Settings.Connection
        mCMD.Parameters.Clear()
        mCMD.Parameters.AddWithValue("@pLocalidade", Localidade)
        ...
        mStrSQL += "AND Localidade=@pLocalidade"
        ...
        While mRDR.Read()
            Dim mListaCPLocalidades As New ClsCP_Localidades

            With mListaCPLocalidades
                .Cod_Postal = mRDR.GetString(mRDR.GetOrdinal("Cod_Postal"))
                .Cod_Distrito = mRDR.GetString(mRDR.GetOrdinal("Cod_Distrito"))
                .Cod_Concelho = mRDR.GetString(mRDR.GetOrdinal("Cod_Concelho"))
                .Localidade = mRDR.GetString(mRDR.GetOrdinal("Localidade"))
            ...
            mCodPostalByLocalidade.Add(mListaCPLocalidades)

        End While
        mRDR.Close()
        mDB.Close()

        Return mCodPostalByLocalidade
    End Function



    Friend Shared Function GetLocalidades() As List(Of ClsCP_Localidades)
        Dim mListaCP_Localidades As New List(Of ClsCP_Localidades)

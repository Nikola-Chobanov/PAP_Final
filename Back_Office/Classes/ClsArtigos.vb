...
#Region "!!Properties!!"
    ...
    Public Property Cod_Categoria As String ' lenght 5
...
#End Region
    ...
    Friend Shared Function GetNovoCodigo(ByVal pPS As enCont) As String
        Dim mReturn As String
        Select Case pPS
            Case enCont.Produtos
                mReturn = "P" & ClsEmpresas.GetContador(enCont.Produtos).ToString("000")
            Case enCont.Servicos
                mReturn = "S" & ClsEmpresas.GetContador(enCont.Servicos).ToString("000")
        End Select
    ...
    Public Shared Function ModificaArtigos(ByVal pClsArtigos As ClsArtigos) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Categoria", pClsArtigos.Cod_Categoria.Substring(0, IIf(Len(pClsArtigos.Cod_Categoria) > 5, 5, Len(pClsArtigos.Cod_Categoria))))
    ...
    Public Shared Function GravaArtigos(ByVal pNovoArtigos As ClsArtigos) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Categoria", pNovoArtigos.Cod_Categoria.Substring(0, IIf(Len(pNovoArtigos.Cod_Categoria) > 5, 5, Len(pNovoArtigos.Cod_Categoria))))
        ...
        Try
            ...
            Select Case pNovoArtigos.FLG_Produto_Servico
                Case "P"
                    ClsEmpresas.GravaContador(enCont.Produtos)
                Case "S"
                    ClsEmpresas.GravaContador(enCont.Servicos)
            End Select
        Catch ex As Exception

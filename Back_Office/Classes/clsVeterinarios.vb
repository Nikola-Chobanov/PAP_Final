...
#Region "Properties"
    ...
    Public Property Email As String                                         ' Len: 80 - SQL_Type: nvarchar                                  ' Len: 20 - SQL_Type: nvarchar
...
#End Region
    ...
    Friend Shared Function GetNovoCodigo() As String
        Return "V" & ClsEmpresas.GetContador(enCont.Veterinarios).ToString("0000") ' <-------------- VERIFICAR O Nº de ZEROS
    End Function
